...
const char* pVSFileName = "../../../src/ogl/06_TranslationTransformation/vs.glsl";
const char* pFSFileName = "../../../src/ogl/06_TranslationTransformation/fs.glsl";
...
int main(int argc, char* argv[])
{
	...
	glutCreateWindow("06 - Translation Transformation (OpenGL)");
